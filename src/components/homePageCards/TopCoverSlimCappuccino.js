...
export default function TopCoverSlimCappuccino(props) {
      ...
      {matchesMDUp ? (
        ...
        {/* <Typography variant="h3" style={{marginLeft:'40%',marginBottom:30}}>Our Offerings</Typography> */}
          ...
          >
            ...
            >
              <Typography variant="h5" style={{marginLeft:100, marginBottom:20}}> Ingredients</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
...
Each capsule embodies sophistication and vitality, offering you more than just health — a daily ritual of luxurious well-being.
            ...
            <Grid
              ...
              style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
            >
              <Typography variant="h5" style={{marginLeft:100, marginBottom:20}}> Health Benefits</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
...
Each blend is a harmony of purity and elegance — a luxurious infusion of nourishment and serenity designed for those who believe wellness should taste as beautiful as it feels.
            ...
            <Grid
              ...
              style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
            >
              <Typography variant="h5" style={{marginLeft:100, marginBottom:20}}> Places To Buy</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
