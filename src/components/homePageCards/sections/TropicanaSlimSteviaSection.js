...
import heroImage from "./../../../assets/images/andersons/stropicanasteviasweetener2.jpg";
...
export default function TropicanaSlimSteviaSection() {
                    ...
                    <Grid
                          ...
                          >
                            ...
                            {/* <Typography style={{marginTop:0, padding: 70}}>
                              ...
                              >
                               <Typography variant="h5" style={{marginLeft:'0%',marginBottom:30, fontWeight:700}}>Advanced Security Solutions & Products You Can Trust</Typography>
                              <Typography style={{marginTop:0, padding: 0,fontSize:10}}>
                                  <strong><ReactMarkdown>Smart Surveillance. Access Control. Peace of Mind.</ReactMarkdown></strong>
                              </Typography>
                                <Typography style={{marginTop:10, fontSize:10}}>
                                <ReactMarkdown>We supply and install premium security systems — from CCTV and alarms to biometric access and perimeter protection. Designed for homes, businesses, and executive facilities across Nigeria.</ReactMarkdown>
                              </Typography>
                              <Typography style={{marginTop:30, fontSize:10}}>
                                <ReactMarkdown>**Cutting-Edge Tech. Expert Installation. Ongoing Support.**</ReactMarkdown>
                              </Typography>
                               <Typography style={{marginTop:30, fontSize:10}}>
                                <em><ReactMarkdown>Protect your space with confidence.</ReactMarkdown></em>
                              </Typography>
                              <Button 
                                variant="contained"
                                disabled={true}
