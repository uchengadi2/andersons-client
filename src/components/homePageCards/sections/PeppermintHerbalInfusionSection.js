...
import heroImage from "./../../../assets/images/bacFoods/peppermint2.jpg";
...
export default function PeppermintHerbalInfusionSection() {
        ...
        {matchesMDUp ? (
          <>
            <Box className={classes.uppercard} disableRipple={true}>
               {/* <Typography variant="h4" style={{marginLeft:'50%',marginBottom:30,fontSize:30, fontWeight:700, color:"black"}}>Security Services</Typography> */}
              <Grid
                container
                direction="row"
              ...
              >
                <Grid
                  container
                  direction="row"
                  style={{ marginLeft: 0, width: "45%", marginTop: 0 }}
                  alignItems="center"
                  ...
                  item
                >
                {/* <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>What Is PPAR (Pay Per Actual Reach)?</Typography> */}
                 ...
                 <Grid
                                    ...
                                    style={{ height: "60%", marginLeft: "0%", width:"50%", padding:30, marginTop:70  }}
                                  >
                                    <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Peppermint Herbal Tea</Typography>
          ...
          <Box className={classes.uppercardMobile} disableRipple>
            {/* <Typography variant="h5" style={{marginLeft:"30%", marginBottom:20, width:"70%"}}>Security Services</Typography> */}
             <Grid
                container
                direction="column"
              ...
              >
                ...
                {/* <Typography style={{marginTop:0, padding: 70}}>
                  ...
                  >
                   <Typography variant="h5" style={{marginLeft:'0%',marginBottom:30, fontWeight:700}}>Professional Security Services for Executives & Businesses</Typography>
                    <Typography style={{marginTop:0, padding: 0,fontSize:12}}>
                          <strong><ReactMarkdown>Personal Protection. Corporate Security. Discreet Excellence.</ReactMarkdown></strong>
                    </Typography>
                    <Typography style={{marginTop:10, fontSize:10}}>
                          <ReactMarkdown>We provide highly trained security personnel for expatriates, business leaders, and organizations that demand top-tier protection. Whether for travel, events, or daily operations, our team is equipped to keep you safe.</ReactMarkdown>
                    </Typography>
                    <Typography style={{marginTop:10, fontSize:10}}>
                          <ReactMarkdown>**Reliable. Responsive. Respected.**</ReactMarkdown>
                    </Typography>
                    <Typography style={{marginTop:10, fontSize:10}}>
                          <em><ReactMarkdown>Because true security is about trust.</ReactMarkdown></em>
                    </Typography>
                  </Grid>
