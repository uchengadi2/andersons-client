...
import heroImage from "./../../../assets/images/andersons/andeglim.jpg";
...
export default function AndeglimSection() {
            ...
            <Box className={classes.uppercard} disableRipple={true}>
              ...
              >
                <Grid
                  container
                  direction="row"
                  style={{ marginLeft: 0, width: "40%", marginTop: 0}}
                  alignItems="center"
                ...
                {/* <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Chauffeur-Driven Exotic Car Rentals in Lagos</Typography> */}
                  <Grid
                    ...
                    style={{ height: "60%", marginLeft: "1%", width:"55%", padding:30, marginTop:70  }}
                  >
             ...
             <Grid
              ...
              >
                ...
                {/* <Typography style={{marginTop:0, padding: 70}}>
                  ...
                  >
                   <Typography variant="h5" style={{marginLeft:'0%',marginBottom:30, fontWeight:700}}>Arrive in Style. Close in Confidence.</Typography>
                    ...
                    <Typography style={{marginTop:10, fontSize:10}}>
                          <ReactMarkdown>Whether you're an expatriate, a business executive, or a company looking to make a lasting impression, we provide premium, chauffeur-driven exotic vehicles tailored for high-stakes meetings, VIP events, and power moves. </ReactMarkdown>
                    </Typography>
                    <Typography style={{marginTop:10, fontSize:10}}>
                          <ReactMarkdown>**Luxury. Professionalism. Presence.**</ReactMarkdown>
                    </Typography>
                    <Typography style={{marginTop:10, fontSize:10}}>
