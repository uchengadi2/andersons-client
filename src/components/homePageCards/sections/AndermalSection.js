...
import heroImage from "./../../../assets/images/andersons/andermal2.jpg";
...
export default function AndermalSection() {
                ...
                >
                  ...
                  {/* <Typography variant="h4" style={{marginLeft:'50%',marginBottom:30, fontSize:30, fontWeight:700, color:"black"}}>Airport Protocol Services</Typography> */}
                    <Grid
                      ...
                      style={{ height: "90%", marginLeft: "0%", width:"50%", padding:10,marginTop:70  }}
                    >
                    ...
                    style={{ marginLeft: 0, width: "40%", marginTop: 50 }}
                    alignItems="center"
                    ...
                    <Grid
                          ...
                          >
                            ...
                            {/* <Typography style={{marginTop:0, padding: 70}}>
                              ...
                              >
                               <Typography variant="h5" style={{marginLeft:'0%',marginBottom:30, fontWeight:700}}>Seamless Airport Protocol Services in Nigeria.</Typography>
                              <Typography style={{marginTop:0, padding: 0,fontSize:10}}>
                                ...
                                <ReactMarkdown>Whether you're an expatriate, a business executive, or a corporate team, our VIP airport protocol services ensure a smooth, stress-free experience from touchdown to takeoff.</ReactMarkdown>
                              </Typography>
                              <Typography style={{marginTop:30, fontSize:10}}>
                                <ReactMarkdown>**Priority Access. Personal Assistance. Total Convenience.**</ReactMarkdown>
                              </Typography>
                               <Typography style={{marginTop:30, fontSize:10}}>
